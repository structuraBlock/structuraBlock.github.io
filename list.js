...
name = "Holy Surf"
packages = ["numpy", "certifi==2022.12.7","cffi==1.15.1","charset-normalizer==3.0.1","idna==3.4","packaging==23.1","platformdirs==3.0.0","pooch==1.7.0","pycparser==2.21","PyNaCl==1.5.0","urllib3==1.26.14" ]
